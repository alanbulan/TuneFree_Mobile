...
export const SidebarCollapseIcon = ({ size = 24, className = "" }) => <PanelLeftClose size={size} className={className} />;
export const SidebarExpandIcon = ({ size = 24, className = "" }) => <PanelLeftOpen size={size} className={className} />;
